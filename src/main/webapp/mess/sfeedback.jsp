...
    </div>
  <div class="container">
    ...
    <table>
        ...
        <tr>
          <td>PRANAY MHATRE</td>
          <td><button type="button" class="btn btn-success">GOOD</button></td>
          <td> <button type="button" class="btn btn-info">POOR</button></td>
          <td><button type="button" class="btn btn-info ">POOR</button></td>
          <td> <button type="button" class="btn btn-warning">Fair</button></td>
          <td>Food Quality should be improved</td>
        ...
        <tr>
            ...
            <td><button type="button" class="btn btn-info ">POOR</button></td>
            <td> <button type="button" class="btn btn-warning">Fair</button></td>
            <td>One suggestion for the warden is that he can change his behavior with the students</td>
