...
    </div>
  <div class="container">
    ...
    <table>
        ...
        <tr>
          <td>PRANAY MHATRE</td>
          <td><button type="button" class="btn btn-info">FRIDAY</button></td>
          <td> <button type="button" class="btn btn-success">Coming</button></td>
          <td><button type="button" class="btn btn-info">SATURDAY</button></td>

          <td> <button type="button" class="btn btn-success">Coming</button></td>
          <td> <button type="button" class="btn btn-success">Coming</button></td>
          <td> <button type="button" class="btn btn-danger">Not-Coming</button></td>
          <td><button type="button" class="btn btn-info">SUNDAY</button></td>
