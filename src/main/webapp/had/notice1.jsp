            ...
            <nav class="flex justify-between">
                ...
                <ul class="navbar flex items-center">
                    ...
                    <li><a class="click" href="sfeedback.jsp">Feedback</a></li>
                     <li><a class="click" href="notice1.jsp">Notice</a></li>
...
    </div>
  <div class="container">
    <div class="title">Write Notice</div>
    ...
    <div class="content">
      <form action="#">
        ...
        <div class="feedback-details">
                ...
                <br>
                <br>
                <textarea id="Suggestions" class="txt" name="Suggestions" placeholder="Write Notice here.."  ></textarea>
              </div>
        </div>
        <div class="button">
      ...
      <div class="button">
                    <a href="notice.jsp"> 
                    <input type="button" value="View Notice">
                </a>
                  </div>
      </form>
    </div>
